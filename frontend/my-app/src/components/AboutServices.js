  ...
  const services = [
    {
      ...
      description: 'Lorem sint occaecat non proident, sunt in culpa quis. Phasellus lacinia id erat eu ullamcorper. Nunc id ipsum fringilla, gravida felis vitae. Phasellus lacinia id, sunt in culpa quis. Phasellus lacinia.',
      link: '#link',
    },
    {
      icon: 'fa-mobile',
        ...
        <div className="container py-lg-5">
          <div className="row w3-icon-grid-gap1">
            {services.map((service, index) => (
              <div key={index} className="col-md-6 w3-icon-grid1">
