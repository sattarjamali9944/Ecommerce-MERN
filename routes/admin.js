...
const { addAttribute,createAttribute,addSubAttribute,createSubAttribute,changeAttributeStatus,getSubAttributes} = require('../server/controllers/AttributeController');
const { addContactPost,allContactJson,contacts } = require('../server/controllers/ContactController');
...
const {addShippingBilling,postShippingBilling} = require('../server/controllers/shippingBillingController');
...
router.get('/add-sub-attribute', addSubAttribute);
router.post('/add-sub-attribute',createSubAttribute);
router.put('/update_attribute_status/:id/',changeAttributeStatus);
router.get('/get_sub_attribute/:id/',getSubAttributes);
//router.get('/add-s',)
/****************OrderController ****************** */
router.get('/orders',orderController.getOrders);
/****************Billing and Shipping Controller*************** */
router.get('/shippingBilling',addShippingBilling);
router.post('/createBillingShipping',postShippingBilling);

/************* Contact Controller Route ****************/
router.post('/api/contact', addContactPost);
router.get('/contactApi', cors(),allContactJson)
